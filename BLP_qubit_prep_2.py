# Script name: qubit_prep_2_v1.py
# Directory path: cd C:\Users\Max\PycharmProjects\pythonProject\ot2_scripting
# Command line simulation = opentrons_simulate.exe qubit_prep_2_v1.py -e
...
metadata = {
    'apiLevel': '2.8',
    'protocolName': 'Barcoded Library Prep: Qubit Prep 2',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    source_sample_well_list = [48, 49, 50, 51, 52, 53, 56, 57, 58, 59, 60, 61] # Well list for samples in columns 3 and 4
